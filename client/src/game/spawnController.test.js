...
const byLevel = {
  1: [
    { speciesId: 1, spawnLevel: 1, formTier: 1, eggGroups: ['monster'], isLegendary: false },
    { speciesId: 4, spawnLevel: 1, formTier: 1, eggGroups: ['monster'], isLegendary: false },
    { speciesId: 7, spawnLevel: 1, formTier: 1, eggGroups: ['monster'], isLegendary: false },
    { speciesId: 25, spawnLevel: 1, formTier: 1, eggGroups: ['monster'], isLegendary: false },
  ],
  6: [{ speciesId: 2, spawnLevel: 6, formTier: 1, eggGroups: ['monster'], isLegendary: false }],
};
