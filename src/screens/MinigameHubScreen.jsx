...
export function MinigameHubScreen() {
  ...
  const coins = player
    ? (player.coins ?? 150)
    : Number(localStorage.getItem("pixelmon-localCoins") || 150);
  const dailyStreak =
    player?.streaks?.dailyStreak ??
    Number(localStorage.getItem("pixelmon-localDailyStreak") || 0);
  const guessStreak =
    player?.streaks?.guessStreak ??
    Number(localStorage.getItem("pixelmon-localGuessStreak") || 0);
    ...
    <div className="minigames-screen">
      <header className="minigames-header">
        ...
        <div className="minigames-header-stats">
          <div
            className="minigames-stat-badge accent"
            title="Your PokéCoins balance"
          >
            <Coins size={15} />
          ...
          {dailyStreak > 0 && (
            <div
              className="minigames-stat-badge streak"
              title="Consecutive days logged in"
            >
              <Flame size={15} />
          ...
          {guessStreak > 0 && (
            <div
              className="minigames-stat-badge"
              title="Consecutive correct guesses streak"
            >
      ...
      <main className="minigames-dashboard">
        ...
        <div className="minigames-bento-grid main-challenges">
          ...
          <button
            ...
            onClick={() => goTo(SCREENS.dailyGrid)}
          >
            ...
            <div className="bento-details">
              ...
              <p className="bento-desc">
                Match region, typing, and legendary status criteria in a 3x3
                PokeDoku grid puzzle.
              </p>
            </div>
          ...
          <button
            type="button"
            className="bento-card featured"
            onClick={() => goTo(SCREENS.clueGuesser)}
          >
            ...
            <div className="bento-details">
              ...
              <p className="bento-desc">
                Guess the mystery daily Pokémon using Wordle-style feedback
                details on stats, regions, and types.
              </p>
            </div>
            <div className="bento-footer">
              <span className="bento-reward-label">Daily Reward</span>
          ...
          <button
            type="button"
            className="bento-card battle-arena"
            onClick={() => goTo(SCREENS.battleArena)}
          >
            ...
            <div className="bento-details">
              ...
              <p className="bento-desc">
                Draft a team of 3 creatures and test your skills in turn-based
                strategic battles with an interactive damage calculator.
              </p>
            </div>
            <div className="bento-footer">
          ...
          <button
            type="button"
            className="bento-card battle-arena-v2"
            onClick={() => goTo(SCREENS.battleArenaV2)}
          >
            ...
            <div className="bento-details">
              ...
              <p className="bento-desc">
                Draft a team and test the reusable battle engine with explicit
                teams, weather, AI, items, and catalog-backed moves.
              </p>
            </div>
            <div className="bento-footer">
        ...
        <div className="minigames-bento-grid training-labs">
          ...
          <button
            ...
            onClick={() => goTo(SCREENS.triviaTraining)}
          >
            ...
            <div className="bento-details">
              ...
              <p className="bento-desc">
                Sharpen your knowledge in Speed Run, Type Matchup, Silhouette,
                and combination quizzes.
              </p>
            </div>
          </button>
          ...
          >
            ...
            <div className="bento-details">
              ...
              <p className="bento-desc">
                Browse your caught Pokémon checklist, base stats, types, and
                unlocked entries catalog.
              </p>
            </div>
          </button>
        </div>
