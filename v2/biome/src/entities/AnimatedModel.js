...
export default function AnimatedModel({
  ...
  const safeUrl = typeof url === 'string' && url.trim()
    ? url
    : '/assets/shared/wild_creature.glb';
...
useGLTF.preload('/assets/shared/player.glb');
useGLTF.preload('/assets/shared/companion.glb');
useGLTF.preload('/assets/shared/wild_creature.glb');
