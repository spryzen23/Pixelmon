...
const Moves = {
  ...
  plasmafists: {
    ...
    onAfterMoveSecondarySelf(pokemon, target, move) {
      if (!this.effectState.bigZera && !this.ruleTable.tagRules.includes("+pokemontag:cap") && pokemon.baseSpecies.baseSpecies === "Zeraora" && pokemon.volatiles["charge"] && !pokemon.transformed) {
